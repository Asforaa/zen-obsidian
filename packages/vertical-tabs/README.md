...
- An optional setting keeps one Local Graph in its own lower-left sidebar section. New panes use the Zen reference graph options and 34.76% height; existing panes and sizing are preserved. Turning the option off closes the Local Graph immediately.
